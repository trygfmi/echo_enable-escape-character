...
<p>このリポジトリは、echoコマンドを実行してエスケープされた改行を含んだ文字列の挙動を確認できます</p>
</div>
...
<div class="wp-block-group">
<p>echoコマンドを実行してエスケープされた改行を含んだ文字列の実行結果を確認してください</p>
...
<div class="wp-block-group">
<pre class="wp-block-own-copy-code-line-block wp-block-code has-24292-eff-color has-cyan-bluish-gray-background-color has-text-color has-background has-1-125-rem-font-size"><code>echo "apple\nbanana\ncherry"
echo -e "apple\nbanana\ncherry"</code></pre>



<details class="wp-block-details"><summary>出力結果</summary>
<pre class="wp-block-code has-background" style="background-color:#ffeeee"><code>apple\nbanana\ncherry
apple
banana
cherry</code></pre>
</details>
...
<pre class="wp-block-code has-24292-eff-color has-text-color has-background has-1-125-rem-font-size" style="background-color:#ffeeee"><code>apple\nbanana\ncherry
apple
banana
cherry</code></pre>
</details>
...
<div class="wp-block-group">
<p>echoコマンドに-eオプションをつけるとエスケープされた文字列を解釈して出力します<br>以下のように-Eオプションをつけると解釈を無効化して出力します</p>
